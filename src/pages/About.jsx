import smartLocker from '../assets/images/smart-locker.jpg';
...
function About() {
  return (
    <div className="container mx-auto py-12 px-4">
      ...
      <img src={smartLocker} alt="Smart Locker" className="w-full max-w-md mx-auto rounded-lg shadow-lg mb-8" />
